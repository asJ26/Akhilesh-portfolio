...
const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/akhilesh-jadhav',
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/akhilesh-jadhav-data/',
    icon: (
      <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="relative border-t border-neutral-200 dark:border-neutral-800">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="flex flex-col items-center justify-center space-y-4 sm:space-y-6">
          ...
          >
            {socialLinks.map((link) => (
              <motion.a
                ...
                className="p-2 -m-2 text-neutral-600 dark:text-white/90 
          ...
          >
            <p className="text-center text-xs sm:text-sm text-neutral-600 dark:text-white/60">
              © {currentYear} Akhilesh Jadhav. All rights reserved.
            </p>
          </motion.div>
        </div>
      </div>
